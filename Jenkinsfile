pipeline {
  ...
  post {
    ...
    unsuccessful {
      emailext attachLog: true, body: 'See the attached log below', subject: 'BUILD $BUILD_NUMBER has failed', to: 'danielleal94+jenkins@gmail.com'
    }
    fixed {
      emailext attachLog: true, body: 'See the attached log below', subject: 'BUILD $BUILD_NUMBER is fine!!', to: 'danielleal94+jenkins@gmail.com'
    }
  }
}
